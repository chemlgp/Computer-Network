...
class SimpleTopo(Topo):
	...
	routers = []
        ...
        lh = ['R1','R2','R3','R4','R5']
        self.addLink(lh[0], lh[1])
        self.addLink(lh[0], lh[2])
        self.addLink(lh[1], lh[2])
        self.addLink(lh[1], lh[3])
        self.addLink(lh[1], lh[4])
        self.addLink(lh[3], lh[4])
        self.addLink(lh[3], lh[2])
        self.addLink(lh[2], lh[4])
